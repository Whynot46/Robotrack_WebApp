...
public class DataBase {
    ...
    public static void add_lesson(int id, int course_id, String date, String time, ArrayList<Integer> students_id) {
        ...
        // Преобразуем список идентификаторов студентов в строку для хранения в базе
        // данных
    ...
    public static void add_new(int id, int author_id, String title, String content, String publish_datetime) {
        String query = "INSERT INTO news (id, author_id, title, content, publish_datetime) VALUES (?, ?, ?, ?, ?)"; // SQL-запрос
                                                                                                                    // для
                                                                                                                    // добавления
                                                                                                                    // новой
                                                                                                                    // записи
    ...
    public static List<User> get_users() {
        ...
        String query = "SELECT id, first_name, patronymic, last_name, birth_date, phone_number, password_hash, role_id FROM users"; // Предполагается,
                                                                                                                                    // что
                                                                                                                                    // role_id
                                                                                                                                    // хранится
                                                                                                                                    // в
        ...
        try (Connection connection = DataBase.getConnection(); // Получаем соединение из класса DataBase
            ...
            while (resultSet.next()) {
                ...
                User user = new User(id, first_name, patronymic, last_name, birth_date, phone_number, password_hash,
                        role_id);
                users.add(user);
            }
        } catch (Exception e) {
    ...
    public static User get_user(int user_id) {
        User user = null;
        String query = "SELECT id, first_name, patronymic, last_name, birth_date, phone_number, password_hash, role_id FROM users WHERE id = ?"; // SQL-запрос
                                                                                                                                                 // для
                                                                                                                                                 // получения
                                                                                                                                                 // пользователя
                                                                                                                                                 // по
        ...
        try (Connection connection = DataBase.getConnection(); // Получаем соединение из класса DataBase
            ...
            if (resultSet.next()) {
                ...
                user = new User(id, first_name, patronymic, last_name, birth_date, phone_number, password_hash,
                        role_id);
            }
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public static ArrayList<New> get_news() {
        ...
        String query = "SELECT id, author_id, title, content, publish_datetime FROM news"; // SQL-запрос для получения
                                                                                           // всех новостей
    ...
    public static New get_new(int new_id) {
        ...
        String query = "SELECT id, author_id, title, content, publish_datetime FROM news WHERE id = ?"; // SQL-запрос
                                                                                                        // для получения
                                                                                                        // новости по id
    ...
    public static ArrayList<New> get_news_from_user(int user_id) {
        ...
        String query = "SELECT id, author_id, title, content, publish_datetime FROM news WHERE author_id = ?"; // SQL-запрос
                                                                                                               // для
                                                                                                               // получения
                                                                                                               // новостей
                                                                                                               // по
    ...
    public static List<Course> get_courses() {
        ...
        String query = "SELECT id, name, age_limit, tasks_id FROM courses"; // SQL-запрос для получения id, name,
                                                                            // age_limit и tasks_id курсов
    ...
    public static Course get_course(int course_id) {
        ...
        String query = "SELECT id, name, age_limit, tasks_id FROM courses WHERE id = ?"; // SQL-запрос для получения
                                                                                         // курса по id
    ...
    public static List<Task> get_tasks() {
        ...
        String query = "SELECT id, name, description FROM tasks"; // SQL-запрос для получения id, name, description и
                                                                  // course_id задач
    ...
    public static int get_child_id(int parent_id) {
        ...
        String query = "SELECT * FROM parent_profile WHERE user_id = ?"; // Предполагаем, что в таблице есть поле
                                                                         // parent_id
    ...
    public static int get_student_last_task_id(int student_id) {
        ...
        String query = "SELECT * FROM student_profile WHERE user_id = ?"; // SQL-запрос для получения last_task_id
                                                                          // студента
    ...
    public static List<Lesson> get_lessons() {
        ...
        String query = "SELECT id, course_id, date, time, students_id FROM lessons"; // SQL-запрос для получения всех
                                                                                     // уроков
            ...
            while (resultSet.next()) {
                ...
                if (students_id_str != null && !students_id_str.isEmpty()) {
                    ...
                    for (String studentId : ids) {
                        students_id.add(Integer.parseInt(studentId.trim())); // Добавляем идентификатор студента в
                                                                             // список
                    }
                }
    ...
    public static StudentProfile get_student_profile(int user_id) {
        ...
        String query = "SELECT * FROM student_profile WHERE user_id = ?"; // SQL-запрос для получения профиля студента
                                                                          // по user_id
        ...
        try (Connection connection = DataBase.getConnection(); // Получаем соединение из класса DataBase
            ...
            if (resultSet.next()) { // Если есть результат
                ...
                // Получаем идентификаторы курсов и занятий (предполагается, что они хранятся в
                // виде строк, разделенных запятыми)
    ...
    public static ParentProfile get_parent_profile(int user_id) {
        ...
        String query = "SELECT * FROM parent_profiles WHERE user_id = ?"; // SQL-запрос для получения профиля родителя
                                                                          // по user_id
        ...
        try (Connection connection = DataBase.getConnection(); // Получаем соединение из класса DataBase
            ...
            if (resultSet.next()) { // Если есть результат
                ...
                parent_profile = new ParentProfile(user_id, child_id); // Создаем объект ParentProfile с полученными
                                                                       // данными
            }
        } catch (SQLException e) {
            e.printStackTrace(); // Обработка исключений
    ...
    public static TeacherProfile get_teacher_profile(int user_id) {
        ...
        String query = "SELECT user_id, courses_id FROM teacher_profiles WHERE user_id = ?"; // SQL-запрос для получения
                                                                                             // профиля учителя по
                                                                                             // user_id
    ...
    public static AdminProfile get_admin_profile(int user_id) {
        ...
        String query = "SELECT user_id FROM admin_profiles WHERE user_id = ?"; // SQL-запрос для получения профиля
                                                                               // администратора по user_id
    ...
    public static void change_user_data(int id, String first_name, String patronymic, String last_name,
            String birth_date, String phone_number, String password, int role_id) {
        String query = "UPDATE users SET first_name = ?, patronymic = ?, last_name = ?, birth_date = ?, phone_number = ?, password_hash = ?, role_id = ? WHERE id = ?"; // SQL-запрос
                                                                                                                                                                        // для
                                                                                                                                                                        // обновления
                                                                                                                                                                        // данных
                                                                                                                                                                        // пользователя
    ...
    public static void change_new_data(int id, int author_id, String title, String content, String publish_datetime) {
        String query = "UPDATE news SET author_id = ?, title = ?, content = ?, publish_datetime = ? WHERE id = ?"; // SQL-запрос
                                                                                                                   // для
                                                                                                                   // обновления
                                                                                                                   // данных
                                                                                                                   // новости
    ...
    public static void change_task_data(int id, String name, String description, int course_id) {
        String query = "UPDATE tasks SET name = ?, description = ?, course_id = ? WHERE id = ?"; // SQL-запрос для
                                                                                                 // обновления данных
                                                                                                 // задания
    ...
    public static void change_course_data(int id, String name, String age_limit, ArrayList<Integer> tasks_id) {
        String query = "UPDATE courses SET name = ?, age_limit = ?, tasks_id = ? WHERE id = ?"; // SQL-запрос для
                                                                                                // обновления данных
                                                                                                // курса
    ...
    public static void change_lesson_data(int id, int course_id, String date, String time,
            ArrayList<Integer> students_id) {
        String query = "UPDATE lessons SET course_id = ?, date = ?, time = ?, students_id = ? WHERE id = ?"; // SQL-запрос
                                                                                                             // для
                                                                                                             // обновления
                                                                                                             // данных
                                                                                                             // занятия
    ...
    public static void change_student_profile(int user_id, String school_shift, int last_task_id,
            ArrayList<Integer> courses_id, ArrayList<Integer> lessons_id) {
        String query = "UPDATE student_profile SET school_shift = ?, last_task_id = ?, courses_id = ?, lessons_id = ? WHERE user_id = ?"; // SQL-запрос
                                                                                                                                          // для
                                                                                                                                          // обновления
                                                                                                                                          // данных
                                                                                                                                          // профиля
        ...
        try (Connection connection = DataBase.getConnection(); // Получаем соединение из класса DataBase
            ...
            // Преобразуем список идентификаторов занятий в строку для хранения в базе
            // данных
    ...
    public static void change_parent_profile(int user_id, int child_id) {
        String query = "UPDATE parent_profiles SET child_id = ? WHERE user_id = ?"; // SQL-запрос для обновления данных
                                                                                    // профиля родителя
    ...
    public static void change_teacher_profile(int user_id, ArrayList<Integer> courses_id) {
        String query = "UPDATE teacher_profiles SET courses_id = ? WHERE user_id = ?"; // SQL-запрос для обновления
                                                                                       // данных профиля учителя
    ...
    public static ArrayList<User> get_most_visiting_students() {
        ...
        String query = "SELECT u.id, u.first_name, u.patronymic, u.last_name, u.birth_date, u.phone_number, u.password, u.role_id, COUNT(ls.student_id) AS visit_count "
                ...
                +
                "WHERE u.role_id = (SELECT id FROM roles WHERE name = 'student') " + // Предполагаем, что у студентов
                                                                                     // есть роль с именем 'student'
                "GROUP BY u.id " +
        ...
        try (Connection connection = DataBase.getConnection(); // Получаем соединение из класса DataBase
            ...
            while (resultSet.next()) { // Обрабатываем все результаты
                ...
                User student = new User(id, first_name, patronymic, last_name, birthdate, phone_number, password,
                        role_id);
    ...
    public static int get_all_visitor_quantity_by_month(int month, int year) {
        ...
        String query = "SELECT COUNT(ls.student_id) AS visitor_count " +
                ...
                "LEFT JOIN (SELECT unnest(string_to_array(students_id, ','))::int AS student_id FROM lessons) ls ON l.id = ls.lesson_id "
                +
                "WHERE EXTRACT(MONTH FROM l.date) = ? AND EXTRACT(YEAR FROM l.date) = ?"; // SQL-запрос для подсчета
                                                                                          // посещений
